...
**Generated from Liferay Structure:** `4325270`
**Structure ID:** `4325271`
...
| Descrizione | `text` |  | - |
| Importo totale intervento | `ddm-number` |  | - |
| Importo finanziato da CM | `ddm-number` |  | - |
| Stato di avanzamento | `text` |  | - |
| Termine lavori previsto | `text` |  | - |
| Nome Allegato | `text` |  | - |
