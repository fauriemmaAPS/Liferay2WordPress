# CardBanner - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `5563290`
**Structure ID:** `5563291`
**ClassNameId:** `10109` - CMN - Contenuti
**Parent Menu:** CMN - Contenuti

## Description

<?xml version='1.0' encoding='UTF-8'?><root available-locales="it_IT" default-locale="it_IT"><Description language-id="it_IT">CardBanner</Description></root>
...
This post type has **1** custom fields:

| Field Name | Type | Required | Description |
|------------|------|----------|-------------|
| Classe Immagine | `text` |  | - |
