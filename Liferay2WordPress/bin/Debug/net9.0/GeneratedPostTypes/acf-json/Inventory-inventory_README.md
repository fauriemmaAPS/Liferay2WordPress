# Inventory - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `INVENTORY`
**Structure ID:** `12503`
...
<?xml version='1.0' encoding='UTF-8'?><root available-locales="en_US" default-locale="en_US"><Description language-id="en_US">Inventory</Description></root>
...
This post type has **6** custom fields:
...
| Item | `text` |  | - |
| Location | `text` |  | - |
| Purchase Date | `ddm-date` |  | - |
| Purchase Price | `ddm-number` |  | - |
| Quantity | `ddm-number` |  | - |
