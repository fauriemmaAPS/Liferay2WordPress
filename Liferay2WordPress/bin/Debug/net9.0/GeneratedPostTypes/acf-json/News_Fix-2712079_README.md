# News_Fix - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `2712079`
**Structure ID:** `2712080`
...
| Immagine | `text` |  | - |
| Immagine2 | `text` |  | - |
| Titolo Banner Immagine | `text` |  | - |
| Titolo Banner Immagine2 | `text` |  | - |
| Titolo Link Immagine | `text` |  | - |
| Titolo Link Immagine2 | `text` |  | - |
| Collegamento Immagine | `ddm-link-to-page` |  | - |
| Collegamento Immagine2 | `ddm-link-to-page` |  | - |
