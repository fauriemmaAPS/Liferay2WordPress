# StrutturaConsiglioMetropolitano - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `1243107`
**Structure ID:** `1243108`
...
This post type has **41** custom fields:

| Field Name | Type | Required | Description |
|------------|------|----------|-------------|
| Data | `ddm-date` |  | - |
| Data di pubblicazione | `checkbox` |  | - |
| Ultimo Aggiornamento | `checkbox` |  | - |
| Proprietà | `text` |  | - |
| Testo | `text` |  | - |
| Nome Allegato | `text` |  | - |
