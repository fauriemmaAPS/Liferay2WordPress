# Pubblicazioni - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `12619`
**Structure ID:** `12620`
...
|------------|------|----------|-------------|
| Immagine logo | `ddm-documentlibrary` |  | - |
| Testo | `text` |  | - |
| Pagina collegata | `ddm-link-to-page` |  | - |
| Pagina esterna collegata | `text` |  | - |
