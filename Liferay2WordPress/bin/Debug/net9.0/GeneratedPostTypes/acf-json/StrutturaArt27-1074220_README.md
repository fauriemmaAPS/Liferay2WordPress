# StrutturaArt27 - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `1074220`
**Structure ID:** `1074221`
...
This post type has **30** custom fields:

| Field Name | Type | Required | Description |
|------------|------|----------|-------------|
| CF o PIVA | `textarea` |  | - |
| Tipo di Rapporto | `select` |  | - |
| Contributo | `option` |  | - |
| Incarico professionale | `option` |  | - |
| Consulenza | `option` |  | - |
| Collaborazione | `option` |  | - |
| Studio | `option` |  | - |
| Ricerca | `option` |  | - |
| Vantaggio economico | `option` |  | - |
| Importo | `ddm-decimal` |  | - |
| Norma o Titolo | `textarea` |  | - |
| Ufficio | `textarea` |  | - |
| Responsabile del procedimento | `textarea` |  | - |
| Modalità utilizzata per individuare il beneficiario | `textarea` |  | - |
