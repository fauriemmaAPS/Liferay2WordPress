# struttura determine a contrarre - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `1732111`
**Structure ID:** `1732112`
...
| Numero Protocollo | `ddm-integer` |  | - |
| Data rubricazione | `ddm-date` |  | - |
| Eventuale spesa prevista | `text` |  | - |
| Estremi documenti | `textarea` |  | - |
| Nome Allegato | `text` |  | - |
