# Defibrillatori - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `5668314`
**Structure ID:** `5668315`
**ClassNameId:** `10109` - CMN - Contenuti
**Parent Menu:** CMN - Contenuti

## Description

<?xml version='1.0' encoding='UTF-8'?><root available-locales="it_IT" default-locale="it_IT"><Description language-id="it_IT">Struttura defibrillatori</Description></root>
...
|------------|------|----------|-------------|
| Modello defibrillatore | `text` |  | - |
| Descrizione sede | `text` |  | - |
| Citta | `text` |  | - |
| Indirizzo | `text` |  | - |
| Ubicazione | `text` |  | - |
