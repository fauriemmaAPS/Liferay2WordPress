# Graduatorie - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `77350`
**Structure ID:** `77351`
...
|------------|------|----------|-------------|
| Lista 1 | `ddm-text-html` |  | - |
| Definizione ai sensi del D.M. 471/99 | `ddm-text-html` |  | - |
| Definizione ai sensi del D.Lgs. 152/06 | `ddm-text-html` |  | - |
