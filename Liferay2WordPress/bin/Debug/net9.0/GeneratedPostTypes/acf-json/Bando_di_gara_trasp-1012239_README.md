# Bando di gara trasp - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `1012239`
**Structure ID:** `1012240`
...
This post type has **21** custom fields:
...
| Cig | `textarea` |  | - |
| oggetto del bando | `textarea` |  | - |
| Struttura proponente | `textarea` |  | - |
| Procedura scelta contraente | `textarea` |  | - |
| Aggiudicatario | `textarea` |  | - |
| Importo | `textarea` |  | - |
| Tempi completamento fornitura | `textarea` |  | - |
| Importo somme liquidate | `textarea` |  | - |
| Determina a contrarre | `textarea` |  | - |
| Determina di liquidazione | `textarea` |  | - |
| Nome Allegato | `text` |  | - |
