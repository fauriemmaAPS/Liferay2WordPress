# Comunicati stampa - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `12765579`
**Structure ID:** `12765580`
...
This post type has **2** custom fields:

| Field Name | Type | Required | Description |
|------------|------|----------|-------------|
| Abstract | `ddm-text-html` |  | - |
| Testo comunicato | `ddm-text-html` |  | - |
