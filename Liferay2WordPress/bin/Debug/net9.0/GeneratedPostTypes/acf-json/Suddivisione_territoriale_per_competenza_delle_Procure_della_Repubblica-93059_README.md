# Suddivisione territoriale per competenza delle Procure della Repubblica - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `93059`
**Structure ID:** `93060`
...
|------------|------|----------|-------------|
| di Napoli | `ddm-text-html` |  | - |
|  	di Torre Annunziata  | `ddm-text-html` |  | - |
| di Nola | `ddm-text-html` |  | - |
