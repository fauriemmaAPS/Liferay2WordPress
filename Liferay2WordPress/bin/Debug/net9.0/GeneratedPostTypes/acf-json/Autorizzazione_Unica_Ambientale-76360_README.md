# Autorizzazione Unica Ambientale - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `76360`
**Structure ID:** `76361`
...
|------------|------|----------|-------------|
| Procedimento | `ddm-text-html` |  | - |
| Normativa Regionale | `ddm-text-html` |  | - |
| Ente Competente in Campania | `ddm-text-html` |  | - |
