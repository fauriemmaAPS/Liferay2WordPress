# Dichiarazioni sulla insussistenza - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `141816`
**Structure ID:** `141817`
...
|------------|------|----------|-------------|
| Cognome | `ddm-text-html` |  | - |
| Nome | `ddm-text-html` |  | - |
| Incarico | `ddm-text-html` |  | - |
| Ente o società | `ddm-text-html` |  | - |
| Dichiarazione | `ddm-text-html` |  | - |
