# Bando di gara - CMN Custom Post Type

**Generation Mode:** `ACF_JSON`
**Generated from Liferay Structure:** `1017697`
**Structure ID:** `1017698`
...
This post type has **24** custom fields:
...
| Cig | `textarea` |  | - |
| Struttura Proponente | `textarea` |  | - |
| Procedura Scelta | `textarea` |  | - |
| Elenco Operatori | `textarea` |  | - |
| Aggiudicatario | `textarea` |  | - |
| Data Inizio | `ddm-date` |  | - |
| Data Fine | `ddm-date` |  | - |
| Data Inizio | `checkbox` |  | - |
| Data Fine | `checkbox` |  | - |
| Determina a contrarre | `textarea` |  | - |
| Determina di aggiudicazione | `textarea` |  | - |
| Importo di aggiudicazione | `ddm-decimal` |  | - |
| Importo delle somme liquidate | `ddm-decimal` |  | - |
